...
const VARIANT_ORDER = ['blush', 'sakura', 'lavender', 'sky', 'sage', 'gold'];
...
const STICKERS = {
  ...
  leaf:      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3"><path d="M20 4C10 4 4 10 4 18v2h2c8 0 14-6 14-16V4Z"/><path d="M6 18C10 14 14 10 18 6"/></svg>',
  sun:       '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3"><circle cx="12" cy="12" r="5"/><path d="M12 1.5v3M12 19.5v3M22.5 12h-3M4.5 12h-3M19.1 4.9l-2.1 2.1M4.9 4.9l2.1 2.1M19.1 19.1l-2.1-2.1M4.9 19.1l2.1-2.1"/></svg>',
  feather:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3"><path d="M20.2 3.8c-4.6 0-13 2-15 9-1 3.5 1 7 4.5 7.5C17 21 20 12 20.2 3.8Z"/><path d="M3 21 12 12"/><path d="M8 15l3 3M11 11l3 3"/></svg>',
  camera:    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.3"><path d="M4 8h3l1.5-2h7L17 8h3a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1Z"/><circle cx="12" cy="14" r="3.5"/></svg>'
};
const STICKER_ORDER = ['heart','rose','butterfly','sparkle','ring','moon','coffee','book','star','leaf','sun','feather','camera'];
